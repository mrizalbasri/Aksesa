      ...
      <div className="relative z-10 mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 items-start gap-8 md:grid-cols-12 md:gap-12">
          <div className="flex flex-col items-start md:col-span-8">
            ...
            >
              Unggah nota 1 tahun, atau isi transaksi harian, atau input penjualan
              marketplace — sesuai data yang Anda miliki.
            </motion.p>
            ...
            >
              ...
              >
                <Link
                  href="/scoring"
                  className="group inline-flex h-12 w-full items-center justify-center rounded border border-[#111111] bg-[#ff5600] px-6 text-sm font-medium text-white transition-colors hover:bg-[#e64d00] sm:h-14 sm:w-auto sm:px-8 sm:text-base"
                >
          ...
          >
            <div className="relative mt-1 md:mt-6">
              ...
              <motion.div
                whileHover={{ y: -6, boxShadow: "0 22px 46px rgba(17,17,17,0.16)" }}
                transition={{ type: "spring", stiffness: 300, damping: 25 }}
                className="relative z-10 rounded-lg border border-[#dedbd6] bg-white p-6 shadow-lg"
              >
                <motion.div
                  initial={{ opacity: 0 }}
                  animate={{ opacity: 1 }}
                  transition={{ duration: 0.4, delay: 0.6 }}
                  className="mb-3 inline-flex items-center rounded bg-[#fff4ee] px-2 py-1 text-[10px] font-semibold uppercase tracking-[0.08em] text-[#ff5600]"
                >
                  Trust Snapshot
                </motion.div>
                ...
                <motion.p
                  ...
                  className="text-sm leading-relaxed text-[#313130]"
                >
                ...
                <motion.div
                  ...
                  className="mt-4 flex items-center justify-between rounded border border-[#e5e0d8] bg-[#fcfaf7] px-3 py-2 text-sm"
                >
                ...
                >
                  ...
                  <motion.div
                    ...
                    className="h-2 w-full overflow-hidden rounded-full bg-[#efeae3]"
                  >
                ...
                <motion.div
                  ...
                  className="mt-4 flex items-center justify-between border-t border-dashed border-[#dedbd6] pt-4"
                >
                  ...
                  <motion.div
                    ...
                    className="text-4xl tracking-tight text-[#111111]"
                  >
